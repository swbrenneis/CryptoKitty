 ...
 */
public class S2KAlgorithmParameterSpec implements AlgorithmParameterSpec {
	 ...
	 */
	public S2KAlgorithmParameterSpec(String passPhrase, int algorithm, byte[] salt)
					throws UnsupportedAlgorithmException {
	 ...
	 * @throws UnsupportedAlgorithmException 
	 */
	public S2KAlgorithmParameterSpec(String passPhrase, int algorithm, byte[] salt, int c)
					throws UnsupportedAlgorithmException {
