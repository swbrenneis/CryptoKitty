...
public class CAST5Cipher extends CipherSpi {
	...
	private void generateSubkeys() {
		...
		Km[0] = (int)k.xor(S6[z[9]]).xor(S7[z[7]]).xor(S8[z[6]]).xor(S5[z[2]]).getValue();
		// K2  = S5[zA] ^ S6[zB] ^ S7[z5] ^ S8[z4] ^ S6[z6]
		k = new Scalar32(S5[z[10]]);
		Km[1] = (int)k.xor(S6[z[11]]).xor(S7[z[5]]).xor(S8[z[4]]).xor(S6[z[6]]).getValue();
		// K3  = S5[zC] ^ S6[zD] ^ S7[z3] ^ S8[z2] ^ S7[z9]
		k = new Scalar32(S5[z[12]]);
		Km[2] = (int)k.xor(S6[z[13]]).xor(S7[z[3]]).xor(S8[z[2]]).xor(S7[z[9]]).getValue();
		// K4  = S5[zE] ^ S6[zF] ^ S7[z1] ^ S8[z0] ^ S8[zC]
		k = new Scalar32(S5[z[14]]);
		Km[2] = (int)k.xor(S6[z[15]]).xor(S7[z[1]]).xor(S8[z[0]]).xor(S8[z[12]]).getValue();
		...
		Km[4] = (int)k.xor(S6[x[2]]).xor(S7[x[12]]).xor(S8[x[13]]).xor(S5[x[8]]).getValue();
		// K6  = S5[x1] ^ S6[x0] ^ S7[xE] ^ S8[xF] ^ S6[xD]
		k = new Scalar32(S5[x[1]]);
		Km[5] = (int)k.xor(S6[x[0]]).xor(S7[x[14]]).xor(S8[x[15]]).xor(S6[x[13]]).getValue();
		// K7  = S5[x7] ^ S6[x6] ^ S7[x8] ^ S8[x9] ^ S7[x3]
		k = new Scalar32(S5[x[7]]);
		Km[6] = (int)k.xor(S6[x[6]]).xor(S7[x[8]]).xor(S8[x[9]]).xor(S7[x[3]]).getValue();
		// K8  = S5[x5] ^ S6[x4] ^ S7[xA] ^ S8[xB] ^ S8[x7]
		k = new Scalar32(S5[x[5]]);
		Km[7] = (int)k.xor(S6[x[4]]).xor(S7[x[10]]).xor(S8[x[11]]).xor(S8[x[7]]).getValue();
		...
		Km[8] = (int)k.xor(S6[z[2]]).xor(S7[z[12]]).xor(S8[z[13]]).xor(S5[z[9]]).getValue();
		// K10 = S5[z1] ^ S6[z0] ^ S7[zE] ^ S8[zF] ^ S6[zC]
		k = new Scalar32(S5[z[1]]);
		Km[9] = (int)k.xor(S6[z[0]]).xor(S7[z[14]]).xor(S8[z[15]]).xor(S6[z[12]]).getValue();
		// K11 = S5[z7] ^ S6[z6] ^ S7[z8] ^ S8[z9] ^ S7[z2]
		k = new Scalar32(S5[z[7]]);
		Km[10] = (int)k.xor(S6[z[6]]).xor(S7[z[8]]).xor(S8[z[9]]).xor(S7[z[2]]).getValue();
		// K12 = S5[z5] ^ S6[z4] ^ S7[zA] ^ S8[zB] ^ S8[z6]
		k = new Scalar32(S5[z[5]]);
		Km[11] = (int)k.xor(S6[z[4]]).xor(S7[z[10]]).xor(S8[z[11]]).xor(S8[z[6]]).getValue();
		...
		if (rounds == 16) {
			...
			Km[12] = (int)k.xor(S6[x[9]]).xor(S7[x[7]]).xor(S8[x[6]]).xor(S5[x[3]]).getValue();
			// K14 = S5[xA] ^ S6[xB] ^ S7[x5] ^ S8[x4] ^ S6[x7]
			k = new Scalar32(S5[x[10]]);
			Km[13] = (int)k.xor(S6[x[11]]).xor(S7[x[5]]).xor(S8[x[4]]).xor(S6[x[7]]).getValue();
			// K15 = S5[xC] ^ S6[xD] ^ S7[x3] ^ S8[x2] ^ S7[x8]
			k = new Scalar32(S5[x[12]]);
			Km[14] = (int)k.xor(S6[x[13]]).xor(S7[x[3]]).xor(S8[x[2]]).xor(S7[x[8]]).getValue();
			// K16 = S5[xE] ^ S6[xF] ^ S7[x1] ^ S8[x0] ^ S8[xD]
			k = new Scalar32(S5[x[14]]);
			Km[15] = (int)k.xor(S6[x[15]]).xor(S7[x[1]]).xor(S8[x[0]]).xor(S8[x[13]]).getValue();
		}
