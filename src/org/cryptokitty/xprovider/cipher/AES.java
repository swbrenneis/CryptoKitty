...
public class AES implements BlockCipher {
	...
	/* (non-Javadoc)
	 * @see org.cryptokitty.provider.cipher.BlockCipher#decrypt(byte[])
	 */
	@Override
	public byte[] decrypt(byte[] ciphertext) throws IllegalBlockSizeException, BadPaddingException  {

		if (ciphertext.length != Nb * 4) {
	        throw new IllegalBlockSizeException("Illegal AES block size");
	    }
	...
	/* (non-Javadoc)
	 * @see org.cryptokitty.provider.cipher.BlockCipher#encrypt(byte[])
	 */
	@Override
	public byte[] encrypt(byte[] plaintext) throws IllegalBlockSizeException, BadPaddingException  {

	    if (plaintext.length != Nb * 4) {
	        throw new IllegalBlockSizeException("AES encrypt: Illegal plaintext size");
	    }
	...
	/* (non-Javadoc)
	 * @see org.cryptokitty.provider.cipher.BlockCipher#getBlockSize()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cryptokitty.provider.cipher.BlockCipher#setKey(byte[])
	 */
	@Override
